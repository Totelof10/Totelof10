...
import { BiPencil } from 'react-icons/bi'; // Using specific icon for edit header
...
function EditCustomer() {
  ...
  const [loading, setLoading] = useState(true); // Initial loading for fetching customer data
  ...
  const validate = () => {
    ...
    if (!customer.phone?.trim()) newErrors.phone = 'Le téléphone est obligatoire';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiErrorMessage = error.response?.data?.message || 'Erreur lors de la modification du client.';
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-700">Chargement des informations du client...</p>
        </div>
      </div>
    );
  }

  // Customer not found state after loading
  if (!customer) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
        <div className="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded-lg shadow-md max-w-md text-center">
          ...
          <p className="text-lg mb-4">Désolé, le client que vous tentez de modifier n'existe pas ou a été supprimé.</p>
          <button
    ...
    <div className="min-h-screen bg-gray-100 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl flex items-center mb-6 md:mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600 text-lg md:text-xl">Modifiez les informations du client</p>
        </div>
      </div>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={customer.name || ''} // Ensure controlled component even if null
